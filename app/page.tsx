...
// 외부 lib 파일 참조를 끊고 직접 주입 (빌드 에러 방지)
...
export default function MessageListPage() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-white font-sans overflow-hidden text-black shadow-lg">
        ...
        <div onClick={() => router.push('/chat')} className="flex items-center px-4 py-3 active:bg-gray-100 cursor-pointer group">
          ...
          <div className="ml-3 flex-1 border-b border-gray-100 pb-3 group-last:border-none">
            <div className="flex justify-between items-baseline mb-0.5">
              ...
              <span className="text-[13px] text-gray-500">오후 5:11</span>
            </div>
            <div className="flex justify-between items-center text-[14px]">
              <p className="text-gray-500 line-clamp-2 leading-snug pr-4">새로운 대화를 시작해보세요.</p>
