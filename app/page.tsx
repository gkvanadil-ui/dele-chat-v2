...
// 외부 파일 참조 없이 직접 연결하여 경로 에러를 원천 차단
  ...
  return (
    <div className="flex flex-col h-screen max-w-md mx-auto bg-white font-sans text-black overflow-hidden">
      ...
      <header className="px-4 pt-12 pb-2 flex justify-between items-center bg-white sticky top-0 z-[100]">
        <button onClick={() => router.push('/settings')} className="text-[#007AFF] text-[17px] active:opacity-50">
          편집
        </button>
        ...
        <div onClick={() => router.push('/chat')} className="flex items-center px-4 py-3 active:bg-gray-100 cursor-pointer group">
          ...
          <div className="ml-3 flex-1 border-b border-gray-100 pb-3 flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <p className="text-gray-500 line-clamp-1 text-[14px]">새로운 메시지가 없습니다.</p>
            </div>
