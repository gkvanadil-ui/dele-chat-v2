...
import { Search, MoreHorizontal, SquarePen, ChevronRight, Image, Clock } from 'lucide-react';
          ...
          {isMenuOpen && (
            <>
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200 py-1 z-[120] overflow-hidden">
                <button onClick={() => router.push('/gallery')} className="w-full px-4 py-3.5 flex items-center justify-between active:bg-gray-100 border-b border-gray-100 text-black">
                  <span className="text-[16px]">사진첩</span>
                  <Image size={18} className="text-gray-400" />
                </button>
                <button onClick={() => router.push('/timeline')} className="w-full px-4 py-3.5 flex items-center justify-between active:bg-gray-100 text-black">
